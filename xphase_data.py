...
class XphaseTransfer:
    def __init__(self, c=3800):
        ...
        # negative values
        self.lut = np.array([1.0000e+00, 1.0000e+00, 1.0000e+00, 1.0000e+00, 1.0000e+00,
        ...
        self.ilut = np.digitize(np.arange(0.0,65282.0,1.0),self.lut,right=True)
